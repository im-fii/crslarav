...
<body>
    ...
    <main>
        <div class="hero-section">
            <img src="{{ asset('images/crs.jpg') }}" alt="Sports Cars" class="background-image">
            <div class="hero-text">
                <h1>Awesome Rental SUV Cars</h1>
                <p class="subtitle">The best car rental with quality luxury cars at affordable prices</p>
                <a href="#recommended-section" class="discover-btn">Details Cars</a>
            </div>
        </div>
    ...
    <script>
        document.querySelector('.discover-btn').addEventListener('click', function(e) {
            e.preventDefault();
            document.querySelector('#recommended-section').scrollIntoView({ behavior: 'smooth' });
        });
    </script>
</body>
</html>
