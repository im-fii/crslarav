...
<body>
    ...
    <main>
        <div class="car-details">
            <div class="car-image">
                <img src="images\mazdacx.png" alt="Mazda Cx-5 2022">
            </div>
            <div class="car-info">
                <h1><?php echo htmlspecialchars($carName); ?></h1>
                <p class="price"><?php echo $formattedPrice; ?> /day</p>
                <p class="stock">
                    Stok mobil: <?php echo $stock; ?>
                </p>
                <br>
                <?php if ($stock > 0) : ?>
                    <a href="check_login.php?redirect=rental.php?car=<?php echo urlencode($carName); ?>&price=<?php echo urlencode($price); ?>" class="rent-btn">Rental sekarang juga!</a>
                <?php else : ?>
